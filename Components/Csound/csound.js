...
var csound = (function() {
  ...
  function createModule() {
    ...
    model.setAttribute('path', 'Components/Csound/pnacl/Release');
    model.setAttribute('src', 'Components/Csound/pnacl/Release/csound.nmf');
   ...
   */
   function moduleDidLoad() {
    ...
    var csoundEngine = document.getElementsByTagName("csound-engine")[0];
    csoundEngine.moduleDidLoad();
  }
